 ...
 * eigSettings: global options from localize_script
 */
					...
					el(blockEditor.InspectorControls, { key: 'inspector' },
						el(components.PanelBody, {
							...
							el(components.SelectControl, {
								label: i18n.__('Title Alignment', 'easy-icon-grid'),
								options: [
...
})(window.wp.blockEditor, window.wp.components, window.wp.i18n, window.wp.element);
